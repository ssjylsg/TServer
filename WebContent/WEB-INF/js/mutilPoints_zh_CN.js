		...
		service = $.post('/TServer/gis/routing', postData, function(msg) {
			if (msg) {
				...
				for ( var i = 0; i < msg.length; i++) {
					...
					$(li).append(ahref).append("第" + (i + 1) + "条路径");
					$(".roads ul").append(li);
				}
			}
			service = null;
			...
			.searchpoicoord(
					...
					function(name) {
						...
						if (type === 'start') {
							...
							$(td2)
									.html(
											'<a href="javascript:void" onclick="deleteMark(this)">删除</a>');
