...
(function($)
{
    ...
    var methods = {
        ...
        showToast : function(options)
		{
			...
			toastItemInner	= $('<div></div>').hide().addClass('toast-item toast-type-error').appendTo(toastWrapAll).html($('<p>').append (localSettings.text)).animate(localSettings.inEffect, localSettings.inEffectDuration).wrap(toastItemOuter);
